...
hosts["fstream365"] = function (url, movieInfo, provider, config, callback) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var DOMAIN, HOST, headers, cryptoLib, CryptoJSAesJson, _0x1fe5e1, headers_1, parseDetail, textDetail, streamRequest, f, encrypted, headerAPI, urlDirect, dataDirect, parseDirect, parseSource, _i, parseSource_1, item, e_1;
    var _this = this;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [2, JSON.parse(JSON.parse(_0x83ff06.toString(cryptoLib.enc.Utf8)))];
                        }
                    });
                }); };
                headers_1 = {
